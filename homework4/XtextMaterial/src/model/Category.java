 ...
 * </p>
 * <ul>
 *   <li>{@link model.Category#isActive <em>Active</em>}</li>
 *   <li>{@link model.Category#isRoot_cat <em>Root cat</em>}</li>
 *   <li>{@link model.Category#getHave_sub_categories <em>Have sub categories</em>}</li>
 *   <li>{@link model.Category#getHave_products <em>Have products</em>}</li>
 *   <li>{@link model.Category#getParent_category <em>Parent category</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getCategory()
 * @model
 * @generated
 */
public interface Category extends Named {
	 ...
	 * @see model.ModelPackage#getCategory_Active()
	 * @model required="true"
	 * @generated
	 */
	boolean isActive();
	...
	/**
	 * Sets the value of the '{@link model.Category#isActive <em>Active</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getCategory_Root_cat()
	 * @model required="true"
	 * @generated
	 */
	boolean isRoot_cat();
	...
	/**
	 * Sets the value of the '{@link model.Category#isRoot_cat <em>Root cat</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getCategory_Have_sub_categories()
	 ...
	 * The list contents are of type {@link model.Product}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Have products</em>' containment reference list.
	 * @see model.ModelPackage#getCategory_Have_products()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see model.ModelPackage#getCategory_Parent_category()
	...
	/**
	 * Sets the value of the '{@link model.Category#getParent_category <em>Parent category</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
