	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.ECOMMERCE_SYSTEM: {
				...
				if (result == null) result = caseNamed(ecommerceSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.CATEGORY: {
				...
				if (result == null) result = caseNamed(category);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.USER: {
				...
				if (result == null) result = caseNamed(user);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CART: {
				...
				if (result == null) result = caseNamed(cart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.ITEM_CART: {
				...
				if (result == null) result = caseNamed(itemCart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.ADDRESS: {
				...
				if (result == null) result = caseNamed(address);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.SHIPMENT: {
				...
				if (result == null) result = caseNamed(shipment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.INVOICE: {
				...
				if (result == null) result = caseNamed(invoice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.ADMINISTRATOR: {
				...
				if (result == null) result = caseNamed(administrator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CUSTOMER: {
				...
				if (result == null) result = caseNamed(customer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
