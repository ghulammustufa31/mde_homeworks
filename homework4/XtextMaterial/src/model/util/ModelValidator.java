...
public class ModelValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public boolean validateEcommerceSystem(EcommerceSystem ecommerceSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateItemCart(ItemCart itemCart, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(itemCart, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(itemCart, diagnostics, context);
		if (result || diagnostics != null) result &= validateItemCart_validStock(itemCart, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateItemCart_validStock(ItemCart itemCart, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ModelPackage.Literals.ITEM_CART,
				 itemCart,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "validStock",
				 ITEM_CART__VALID_STOCK__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	...
	public boolean validateOrder(Order order, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOrder_validOrderStatusPaid(order, diagnostics, context);
		if (result || diagnostics != null) result &= validateOrder_validOrderStatusUnpaid(order, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateOrder_validOrderStatusPaid(Order order, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ModelPackage.Literals.ORDER,
				 order,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "validOrderStatusPaid",
				 ORDER__VALID_ORDER_STATUS_PAID__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	 ...
	 * @generated
	 */
	public boolean validateOrder_validOrderStatusUnpaid(Order order, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ModelPackage.Literals.ORDER,
				 order,
				 ...
				 ORDER__VALID_ORDER_STATUS_UNPAID__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	 ...
	 * @generated
	 */
	public boolean validateProductImage(ProductImage productImage, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateShipmentStatus(ShipmentStatus shipmentStatus, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
