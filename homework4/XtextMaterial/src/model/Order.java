 ...
 * </p>
 * <ul>
 *   <li>{@link model.Order#getReference_number <em>Reference number</em>}</li>
 *   <li>{@link model.Order#getDate_created <em>Date created</em>}</li>
 *   <li>{@link model.Order#getOrder_state <em>Order state</em>}</li>
 *   <li>{@link model.Order#getOrder_has_invoice <em>Order has invoice</em>}</li>
 *   <li>{@link model.Order#getOrder_have_shipment <em>Order have shipment</em>}</li>
 *   <li>{@link model.Order#getOrder_for_cart <em>Order for cart</em>}</li>
 *   <li>{@link model.Order#getTotal_price_order <em>Total price order</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getOrder()
...
public interface Order extends EObject {
	 ...
	 * @see model.ModelPackage#getOrder_Reference_number()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link model.Order#getReference_number <em>Reference number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getOrder_Date_created()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link model.Order#getDate_created <em>Date created</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link model.OrderState}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Order state</em>' attribute.
	 * @see model.OrderState
	 * @see #setOrder_state(OrderState)
	 * @see model.ModelPackage#getOrder_Order_state()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link model.Order#getOrder_state <em>Order state</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getOrder_Order_has_invoice()
	...
	/**
	 * Sets the value of the '{@link model.Order#getOrder_has_invoice <em>Order has invoice</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link model.Shipment}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Order have shipment</em>' containment reference list.
	 * @see model.ModelPackage#getOrder_Order_have_shipment()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see model.ModelPackage#getOrder_Order_for_cart()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link model.Order#getOrder_for_cart <em>Order for cart</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model.ModelPackage#getOrder_Total_price_order()
	...
	/**
	 * Sets the value of the '{@link model.Order#getTotal_price_order <em>Total price order</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
