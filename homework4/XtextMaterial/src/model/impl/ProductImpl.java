 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ProductImpl#isAvailable <em>Available</em>}</li>
 *   <li>{@link model.impl.ProductImpl#getStock <em>Stock</em>}</li>
 *   <li>{@link model.impl.ProductImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link model.impl.ProductImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link model.impl.ProductImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link model.impl.ProductImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link model.impl.ProductImpl#getProduct_have_images <em>Product have images</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductImpl extends NamedImpl implements Product {
	...
	public void setAvailable(boolean newAvailable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PRODUCT__AVAILABLE, oldAvailable, available));
	}
	...
	public EList<ProductImage> getProduct_have_images() {
		if (product_have_images == null) {
			product_have_images = new EObjectContainmentEList<ProductImage>(ProductImage.class, this, ModelPackage.PRODUCT__PRODUCT_HAVE_IMAGES);
		}
