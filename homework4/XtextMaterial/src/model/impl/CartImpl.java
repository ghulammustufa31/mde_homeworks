 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.CartImpl#getDate_added <em>Date added</em>}</li>
 *   <li>{@link model.impl.CartImpl#getCart_have_items <em>Cart have items</em>}</li>
 *   <li>{@link model.impl.CartImpl#getCart_have_order <em>Cart have order</em>}</li>
 *   <li>{@link model.impl.CartImpl#getTotal_price <em>Total price</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CartImpl extends NamedImpl implements Cart {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate TOTAL_PRICE__ESETTING_DELEGATE = ((EStructuralFeature.Internal)ModelPackage.Literals.CART__TOTAL_PRICE).getSettingDelegate();
	...
	public void setDate_added(Date newDate_added) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CART__DATE_ADDED, oldDate_added, date_added));
	}
	...
	public EList<ItemCart> getCart_have_items() {
		if (cart_have_items == null) {
			cart_have_items = new EObjectContainmentEList<ItemCart>(ItemCart.class, this, ModelPackage.CART__CART_HAVE_ITEMS);
		}
	...
	public NotificationChain basicSetCart_have_order(Order newCart_have_order, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.CART__CART_HAVE_ORDER, oldCart_have_order, newCart_have_order);
	...
	public void setCart_have_order(Order newCart_have_order) {
		if (newCart_have_order != cart_have_order) {
			...
			if (cart_have_order != null)
				msgs = ((InternalEObject)cart_have_order).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CART__CART_HAVE_ORDER, null, msgs);
			if (newCart_have_order != null)
				msgs = ((InternalEObject)newCart_have_order).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CART__CART_HAVE_ORDER, null, msgs);
			msgs = basicSetCart_have_order(newCart_have_order, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CART__CART_HAVE_ORDER, newCart_have_order, newCart_have_order));
	}
