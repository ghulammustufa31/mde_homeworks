 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.CustomerImpl#getCustomer_have_address <em>Customer have address</em>}</li>
 *   <li>{@link model.impl.CustomerImpl#getCustomer_have_cart <em>Customer have cart</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomerImpl extends UserImpl implements Customer {
	...
	public EList<Address> getCustomer_have_address() {
		if (customer_have_address == null) {
			customer_have_address = new EObjectContainmentEList<Address>(Address.class, this, ModelPackage.CUSTOMER__CUSTOMER_HAVE_ADDRESS);
		}
	...
	public NotificationChain basicSetCustomer_have_cart(Cart newCustomer_have_cart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.CUSTOMER__CUSTOMER_HAVE_CART, oldCustomer_have_cart, newCustomer_have_cart);
	...
	public void setCustomer_have_cart(Cart newCustomer_have_cart) {
		if (newCustomer_have_cart != customer_have_cart) {
			...
			if (customer_have_cart != null)
				msgs = ((InternalEObject)customer_have_cart).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CUSTOMER__CUSTOMER_HAVE_CART, null, msgs);
			if (newCustomer_have_cart != null)
				msgs = ((InternalEObject)newCustomer_have_cart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CUSTOMER__CUSTOMER_HAVE_CART, null, msgs);
			msgs = basicSetCustomer_have_cart(newCustomer_have_cart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CUSTOMER__CUSTOMER_HAVE_CART, newCustomer_have_cart, newCustomer_have_cart));
	}
