 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.ItemCartImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link model.impl.ItemCartImpl#getItem_cart_have_product <em>Item cart have product</em>}</li>
 *   <li>{@link model.impl.ItemCartImpl#getTotal_price <em>Total price</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemCartImpl extends NamedImpl implements ItemCart {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate TOTAL_PRICE__ESETTING_DELEGATE = ((EStructuralFeature.Internal)ModelPackage.Literals.ITEM_CART__TOTAL_PRICE).getSettingDelegate();
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ITEM_CART__QUANTITY, oldQuantity, quantity));
	}
	...
	public Product getItem_cart_have_product() {
		if (item_cart_have_product != null && item_cart_have_product.eIsProxy()) {
			...
			if (item_cart_have_product != oldItem_cart_have_product) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.ITEM_CART__ITEM_CART_HAVE_PRODUCT, oldItem_cart_have_product, item_cart_have_product));
			}
		}
	...
	public void setItem_cart_have_product(Product newItem_cart_have_product) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ITEM_CART__ITEM_CART_HAVE_PRODUCT, oldItem_cart_have_product, item_cart_have_product));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.ITEM_CART__ITEM_CART_HAVE_PRODUCT:
				if (resolve) return getItem_cart_have_product();
