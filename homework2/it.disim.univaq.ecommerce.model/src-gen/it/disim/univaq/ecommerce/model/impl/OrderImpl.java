 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.OrderImpl#getReference_number <em>Reference number</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.OrderImpl#getDate_created <em>Date created</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.OrderImpl#getOrder_state <em>Order state</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.OrderImpl#getOrder_has_invoice <em>Order has invoice</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.OrderImpl#getOrder_have_shipment <em>Order have shipment</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.OrderImpl#getOrder_for_cart <em>Order for cart</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.OrderImpl#getTotal_price_order <em>Total price order</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderImpl extends MinimalEObjectImpl.Container implements Order {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate TOTAL_PRICE_ORDER__ESETTING_DELEGATE = ((EStructuralFeature.Internal) ModelPackage.Literals.ORDER__TOTAL_PRICE_ORDER)
			.getSettingDelegate();
	...
	public Cart getOrder_for_cart() {
		if (order_for_cart != null && order_for_cart.eIsProxy()) {
			...
			if (order_for_cart != oldOrder_for_cart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.ORDER__ORDER_FOR_CART,
							oldOrder_for_cart, order_for_cart));
			}
		}
	...
	public void setOrder_for_cart(Cart newOrder_for_cart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ORDER__ORDER_FOR_CART, oldOrder_for_cart,
					order_for_cart));
	}
