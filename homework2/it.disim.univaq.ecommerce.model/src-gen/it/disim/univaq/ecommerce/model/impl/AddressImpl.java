 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.AddressImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.AddressImpl#getState <em>State</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.AddressImpl#getCity <em>City</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.AddressImpl#getPost_code <em>Post code</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.AddressImpl#getPhone <em>Phone</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.AddressImpl#isActive <em>Active</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.AddressImpl#getStreet_address <em>Street address</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddressImpl extends NamedImpl implements Address {
	...
	public void setPost_code(String newPost_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ADDRESS__POST_CODE, oldPost_code,
					post_code));
	}
	...
	public void setStreet_address(String newStreet_address) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ADDRESS__STREET_ADDRESS,
					oldStreet_address, street_address));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ModelPackage.ADDRESS__STREET_ADDRESS:
			return STREET_ADDRESS_EDEFAULT == null ? street_address != null
					: !STREET_ADDRESS_EDEFAULT.equals(street_address);
		}
