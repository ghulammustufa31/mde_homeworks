 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.CategoryImpl#isActive <em>Active</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.CategoryImpl#isRoot_cat <em>Root cat</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.CategoryImpl#getHave_sub_categories <em>Have sub categories</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.CategoryImpl#getHave_products <em>Have products</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.model.impl.CategoryImpl#getParent_category <em>Parent category</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends NamedImpl implements Category {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate PARENT_CATEGORY__ESETTING_DELEGATE = ((EStructuralFeature.Internal) ModelPackage.Literals.CATEGORY__PARENT_CATEGORY)
			.getSettingDelegate();
