 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.univaq.ecommerce.ecommerce_application.impl.ShipmentImpl#getShipment_status <em>Shipment status</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.ecommerce_application.impl.ShipmentImpl#getDate <em>Date</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.ecommerce_application.impl.ShipmentImpl#getShipment_no <em>Shipment no</em>}</li>
 *   <li>{@link it.disim.univaq.ecommerce.ecommerce_application.impl.ShipmentImpl#getShipment_has_address <em>Shipment has address</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShipmentImpl extends NamedImpl implements Shipment {
	...
	public void setShipment_status(ShipmentStatus newShipment_status) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SHIPMENT__SHIPMENT_STATUS,
					oldShipment_status, shipment_status));
	}
	...
	public void setShipment_no(String newShipment_no) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SHIPMENT__SHIPMENT_NO, oldShipment_no,
					shipment_no));
	}
			...
			if (shipment_has_address != oldShipment_has_address) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModelPackage.SHIPMENT__SHIPMENT_HAS_ADDRESS, oldShipment_has_address,
							shipment_has_address));
			}
		}
	...
	public void setShipment_has_address(Address newShipment_has_address) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SHIPMENT__SHIPMENT_HAS_ADDRESS,
					oldShipment_has_address, shipment_has_address));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelPackage.SHIPMENT__SHIPMENT_HAS_ADDRESS:
			if (resolve)
				return getShipment_has_address();
