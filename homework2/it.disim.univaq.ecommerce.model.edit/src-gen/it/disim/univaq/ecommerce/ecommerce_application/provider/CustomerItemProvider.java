...
/**
 * This is the item provider adapter for a {@link it.disim.univaq.ecommerce.ecommerce_application.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomerItemProvider extends UserItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.CUSTOMER__CUSTOMER_HAVE_ADDRESS);
			childrenFeatures.add(ModelPackage.Literals.CUSTOMER__CUSTOMER_HAVE_CART);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ModelPackage.Literals.CUSTOMER__CUSTOMER_HAVE_ADDRESS,
				ModelFactory.eINSTANCE.createAddress()));

		newChildDescriptors.add(createChildParameter(ModelPackage.Literals.CUSTOMER__CUSTOMER_HAVE_CART,
				ModelFactory.eINSTANCE.createCart()));
	}
