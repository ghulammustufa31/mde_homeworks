...
public class AddressItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAddress_idPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Address id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAddress_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Address_address_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Address_address_id_feature",
								"_UI_Address_type"),
						ModelPackage.Literals.ADDRESS__ADDRESS_ID, true, false, false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Address_type") + " " + address.getAddress_id();
	}
